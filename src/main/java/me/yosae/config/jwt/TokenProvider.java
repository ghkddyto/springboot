...
public class TokenProvider {
    ...
    private String makeToken(Date expiry, User user) {
        ...
        return Jwts.builder()
                ...
                .setIssuer(jwtProperties.getIssuer()) // 내용 iss : ajufresh@gmail.com(properties 파일에서 설정한 갑)
    ...
    public boolean validToken(String token) {
        try {
            Jwts.parser()
                    .setSigningKey(jwtProperties.getSecretKey()) //비밀값을 복호화
